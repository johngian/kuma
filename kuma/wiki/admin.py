...
from .models import (BCDSignal, Document, DocumentDeletionLog, DocumentSpamAttempt,
...
@admin.register(BCDSignal)
class BCDSignalAdmin(admin.ModelAdmin):
    list_display = ['pk', 'document', 'submitted_at', 'user']
